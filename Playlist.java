...
public class Playlist
{
	...
	public void printContents()
	{
		for(int i = 0; i < contents.size(); i++)
		{
			...
			contents.get(i).printInfo();	// gets content at index i and uses the method printInfo()
			System.out.println();	// formatting, adds space between lines
		}
	}
	...
	public void playAll()
	{
		for(int i = 0; i < contents.size(); i++)
		{
			contents.get(i).play(); // gets contents at index i and play()
			System.out.println();
		}
	}
	...
	{
		System.out.println();
		contents.get(index-1).play(); // contents at (index - 1) and plays it using play()
	}
	...
	{
		Playlist othPlaylist = (Playlist) other; // making a Playlist object by typecasting the Object other given
		return (this.title.equals(othPlaylist.title)); // returns if current title is equal to the other title
